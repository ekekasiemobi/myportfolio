...
function Nav() {
  ...
  return (
    <>
        <div className='bg-[#222831] text-[#CCD6F6] fixed w-full shadow-lg'>

            <nav className='container mx-auto '>

                <div className='flex justify-between pt-7 pb-7 w-[90%] mx-auto'>
                    <Link className='font-extrabold md:text-[22px] text-[20px]' href="">Kasiemobi Eke</Link>
                    ...
                    {isOpen && 
                        <div className="absolute md:hidden shadow-lg flex flex-col pt-5 w-[70%] bg-[#222831] gap-7 right-0 mt-10 h-screen px-7">
